...
public class MapPedido : MapBase<PedidoEntidade>
{
    public override void Configure(EntityTypeBuilder<PedidoEntidade> builder)
    {
        ...
        builder.Property(p => p.QuantidadeProdutos).IsRequired().HasColumnName("QuantidadeProdutos").HasMaxLength(10);
        builder.Property(p => p.ValorTotalPedido).IsRequired().HasColumnName("ValorTotalPedido").HasMaxLength(255);
    }
}
